...
"""
https://github1s.com/OmidPoursaeed/Generative_Adversarial_Perturbations/blob/master/material/models/generators.py
"""
...
class CifarResnetGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, ngf, norm_type, act_type='selu', use_dropout=False, 
        ...
        # out = (input - 1) * stride + out_padding - 2 * padding + kernelsize
...
class ResnetBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        logging.debug(f" x size: {x.shape} out size: {out.shape}")
        return out
